            ...
            ->schema([
                SchemaComponents\Section::make('Thông tin đơn')
                    ...
                    ->schema([
                        ...
                        Infolists\Components\TextEntry::make('status')->label('Trạng thái')
                            ->formatStateUsing(fn ($state) => $state->label())
                            ->badge(),
                        Infolists\Components\TextEntry::make('supplier.name')->label('Nhà cung cấp'),
                        Infolists\Components\TextEntry::make('warehouse.name')->label('Kho nhập')
                        ...
                        Infolists\Components\TextEntry::make('receive_date')->label('Ngày nhận')->date('d/m/Y')
                            ->placeholder('—'),
                        Infolists\Components\TextEntry::make('linkedSalesOrder.order_number')
                            ->label('SO liên kết')
                            ->placeholder('—')
                            ->url(fn (PurchaseOrder $record) => $record->linked_sales_order_id
                                ? \App\Filament\Resources\SalesOrderResource::getUrl('view', ['record' => $record->linked_sales_order_id])
                                : null),
                    ]),
                    ...
                    ->schema([
                        Infolists\Components\RepeatableEntry::make('lines')
                            ...
                            ->schema([
                                ...
                                Infolists\Components\TextEntry::make('quantity')->label('Đặt'),
                                Infolists\Components\TextEntry::make('ordered_quantity')->label('Đã xác nhận'),
                                Infolists\Components\TextEntry::make('received_quantity')->label('Đã nhận'),
                                Infolists\Components\TextEntry::make('unit_cost')->label('Đơn giá')->money('VND'),
                ...
                SchemaComponents\Section::make('Tổng hợp')
                    ...
                    ->schema([
                        ...
                        Infolists\Components\TextEntry::make('tax_amount')->label('Thuế VAT')->money('VND'),
