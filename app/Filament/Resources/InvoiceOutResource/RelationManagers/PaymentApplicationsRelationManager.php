...
namespace App\Filament\Resources\InvoiceOutResource\RelationManagers;
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('payment.party_type')
                    ->label('Loại')
            ...
            ->headerActions([
                // Không cho thêm trực tiếp - phải tạo Payment rồi apply
            ])
            ->actions([
                Tables\Actions\Action::make('unapply')
                    ...
                    ->action(function (PaymentApplication $record) {
                        try {
                            ...
                            Notification::make()->title('Đã gỡ thanh toán')->success()->send();
                        } catch (\Throwable $e) {
